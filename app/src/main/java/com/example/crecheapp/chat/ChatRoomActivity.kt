...
import com.example.crecheapp.*
import com.example.crecheapp.chat.model.MessageType
import com.example.crecheapp.databinding.ActivityChatroomBinding
...
class ChatRoomActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun addItemToRecyclerView(message: Message) = with(binding) {
